...
def rem_cmds(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if args[0].lower() in ("on", "yes"):
        ...
        update.effective_message.reply_text("yes,I am trying to delete the commands!")
        return "<b>{}:</b>" \
               "\n#ANTI_COMMAND" \
               "\n<b>Admin:</b> {}" \
        ...
        update.effective_message.reply_text("no, i am not delete the commands!")
        return "<b>{}:</b>" \
               "\n#ANTI_COMMAND" \
               "\n<b>Admin:</b> {}" \
        ...
        update.effective_message.reply_text("I dont understsand... Type 'on/yes' or 'off/no' !")
        return ""
